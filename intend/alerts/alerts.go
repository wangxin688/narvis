...
func getAlertNameMeta() map[AlertNameEnum]AlertName {
	...
	alertNameMeta := map[AlertNameEnum]AlertName{
		...
		HighCpuUsage: {
			Name:  HighCpuUsage,
			Title: schemas.I18n{En: "High CPU usage", Zh: "CPU利用率过高"},
			Suggestion: schemas.I18n{
		...
		HighMemoryUsage: {
			...
			Title: schemas.I18n{En: "High memory usage", Zh: "内存利用率过高"},
			Suggestion: schemas.I18n{
		...
		HighDiskUsage: {
			Name:       HighDiskUsage,
			Title:      schemas.I18n{En: "High disk usage", Zh: "磁盘利用率过高"},
			Suggestion: schemas.I18n{En: "1. Check device process disk utilization", Zh: "1. 检查设备磁盘利用率"},
			Severity:   SeverityWarning,
		},
		HighSystemLoad: {
			Name:  HighSystemLoad,
			Title: schemas.I18n{En: "High system load", Zh: "系统负载过高"},
			Suggestion: schemas.I18n{
				En: "1.Check device load\n2.Check device process cpu utilization\n3.check network traffic load",
				Zh: "检查设备负载\n2. 检查设备进程CPU利用率(cpu/memory)\n3. 检查网络流量负载"},
			Severity: SeverityWarning,
		...
		HighChannelUsage: {
			...
			Title: schemas.I18n{En: "High channel usage", Zh: "信道利用率过高"},
			Suggestion: schemas.I18n{
		...
		HighChannelNoise: {
			...
			Title:      schemas.I18n{En: "High channel noise", Zh: "信道噪声过高"},
			Suggestion: schemas.I18n{En: "1. Check office physical and electronical environment", Zh: "1. 检查办公室物理和电器设备环境"},
			Severity:   SeverityInfo,
		},
		HighChannelInterference: {
			Name:  HighChannelInterference,
			Title: schemas.I18n{En: "High channel interference", Zh: "信道干扰过高"},
			Suggestion: schemas.I18n{
		...
		HighClientNumber: {
			...
			Title: schemas.I18n{En: "High client number", Zh: "客户端数量过多"},
			Suggestion: schemas.I18n{
		...
		HighBandwidthUsage: {
			...
			Title: schemas.I18n{En: "High bandwidth usage", Zh: "带宽利用率过高"},
			Suggestion: schemas.I18n{
		...
		HighErrorRate: {
			Name:       HighErrorRate,
			Title:      schemas.I18n{En: "High error rate", Zh: "错包率过高"},
			Suggestion: schemas.I18n{En: "1.Check interface CRC error to issue physical layer\n2.Check traffic load\n", Zh: "1. 检查接口CRC错包,排查物理层连接问题\n2. 检查流量负载"},
			Severity:   SeverityInfo,
		},
		HighICMPLatency: {
			Name:  HighICMPLatency,
			Title: schemas.I18n{En: "High ICMP latency", Zh: "ICMP延迟过高"},
			Suggestion: schemas.I18n{
		...
		HighICMPPacketLoss: {
			...
			Title: schemas.I18n{En: "High ICMP packet loss", Zh: "ICMP丢包率过高"},
			Suggestion: schemas.I18n{
				En: `1.Check internet/intranet network packet loss rate\n
						 2.Check traffic status for inter-connective devices\n
						 3.Check device load(cpu/memory/process)`,
		...
		HighTemperature: {
			...
			Title: schemas.I18n{En: "High temperature", Zh: "硬件温度过高"},
			Suggestion: schemas.I18n{
		...
		AbnormalFanStatus: {
			...
			Title: schemas.I18n{En: "Abnormal fan status", Zh: "风扇状态异常"},
			Suggestion: schemas.I18n{
				En: "1.Check Cooling device/sensor status in ServerRoom\n2.Check device hardware status\n",
				Zh: "1. 检查机房冷却设备/传感器状态\n2. 检查设备硬件状态",
			},
		...
		AbnormalPowerStatus: {
			...
			Title: schemas.I18n{En: "Abnormal power status", Zh: "电源状态异常"},
			Suggestion: schemas.I18n{
		...
		InterfaceDown: {
			Name:  InterfaceDown,
			Title: schemas.I18n{En: "Interface down", Zh: "接口状态异常"},
			Suggestion: schemas.I18n{
		...
		SnmpAgentTimeout: {
			...
			Title: schemas.I18n{En: "SNMP agent timeout", Zh: "SNMP采集超时"},
			Suggestion: schemas.I18n{
		...
		NodePingTimeout: {
			...
			Title: schemas.I18n{En: "Node ping timeout", Zh: "节点Ping超时"},
			Suggestion: schemas.I18n{
				En: `
		...
		ApDown: {
			Name:  ApDown,
			Title: schemas.I18n{En: "AP down", Zh: "AP离线"},
			Suggestion: schemas.I18n{
		...
		Unknown: {
			Name:  Unknown,
			Title: schemas.I18n{En: "Unknown", Zh: "未知"},
			Suggestion: schemas.I18n{
				En: "1.Unknown",
				Zh: "1. 未知",
			},
