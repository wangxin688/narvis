...
func newMacAddress(db *gorm.DB, opts ...gen.DOOption) macAddress {
	...
	_macAddress.MacOUI = field.NewString(tableName, "macOui")
	_macAddress.ShortName = field.NewString(tableName, "shortName")
	_macAddress.LongName = field.NewString(tableName, "longName")
...
func (m *macAddress) updateTableName(table string) *macAddress {
	...
	m.MacOUI = field.NewString(table, "macOui")
	m.ShortName = field.NewString(table, "shortName")
	m.LongName = field.NewString(table, "longName")
...
func (m *macAddress) fillFieldMap() {
	...
	m.fieldMap["Id"] = m.Id
	m.fieldMap["macOui"] = m.MacOUI
	m.fieldMap["shortName"] = m.ShortName
	m.fieldMap["longName"] = m.LongName
}
