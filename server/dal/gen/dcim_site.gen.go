...
func newSite(db *gorm.DB, opts ...gen.DOOption) site {
	...
	_site.siteDo.UseModel(&models.Site{})
...
type siteBelongsToOrganization struct {
	db *gorm.DB

	field.RelationField
}

func (a siteBelongsToOrganization) Where(conds ...field.Expr) *siteBelongsToOrganization {
	if len(conds) == 0 {
		return &a
	}
...
func (a siteBelongsToOrganization) WithContext(ctx context.Context) *siteBelongsToOrganization {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a siteBelongsToOrganization) Session(session *gorm.Session) *siteBelongsToOrganization {
	a.db = a.db.Session(session)
	return &a
}

func (a siteBelongsToOrganization) Model(m *models.Site) *siteBelongsToOrganizationTx {
	return &siteBelongsToOrganizationTx{a.db.Model(m).Association(a.Name())}
}

type siteBelongsToOrganizationTx struct{ tx *gorm.Association }

func (a siteBelongsToOrganizationTx) Find() (result *models.Organization, err error) {
	return result, a.tx.Find(&result)
}

func (a siteBelongsToOrganizationTx) Append(values ...*models.Organization) (err error) {
...
func (a siteBelongsToOrganizationTx) Replace(values ...*models.Organization) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a siteBelongsToOrganizationTx) Delete(values ...*models.Organization) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a siteBelongsToOrganizationTx) Clear() error {
	return a.tx.Clear()
}

func (a siteBelongsToOrganizationTx) Count() int64 {
	return a.tx.Count()
}
...
type ISiteDo interface {
	...
	Unscoped() ISiteDo
	Create(values ...*models.Site) error
	CreateInBatches(values []*models.Site, batchSize int) error
	Save(values ...*models.Site) error
	First() (*models.Site, error)
	Take() (*models.Site, error)
	Last() (*models.Site, error)
	Find() ([]*models.Site, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Site, err error)
	FindInBatches(result *[]*models.Site, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Site) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Site, error)
	FirstOrCreate() (*models.Site, error)
	FindByPage(offset int, limit int) (result []*models.Site, count int64, err error)
...
func (s siteDo) Create(values ...*models.Site) error {
	if len(values) == 0 {
		return nil
	}
...
func (s siteDo) CreateInBatches(values []*models.Site, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s siteDo) Save(values ...*models.Site) error {
	if len(values) == 0 {
		return nil
	}
...
func (s siteDo) First() (*models.Site, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Site), nil
	}
}

func (s siteDo) Take() (*models.Site, error) {
...
func (s siteDo) Last() (*models.Site, error) {
...
func (s siteDo) Find() ([]*models.Site, error) {
	result, err := s.DO.Find()
	return result.([]*models.Site), err
}

func (s siteDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Site, err error) {
	buf := make([]*models.Site, 0, batchSize)
...
func (s siteDo) FindInBatches(result *[]*models.Site, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s siteDo) FirstOrInit() (*models.Site, error) {
...
func (s siteDo) FirstOrCreate() (*models.Site, error) {
...
func (s siteDo) FindByPage(offset int, limit int) (result []*models.Site, count int64, err error) {
...
func (s siteDo) Delete(models ...*models.Site) (result gen.ResultInfo, err error) {
