...
func newMenu(db *gorm.DB, opts ...gen.DOOption) menu {
	...
	_menu.CreatedAt = field.NewTime(tableName, "createdAt")
	_menu.UpdatedAt = field.NewTime(tableName, "updatedAt")
	...
	_menu.ParentId = field.NewString(tableName, "parentId")
...
func (m *menu) updateTableName(table string) *menu {
	...
	m.ParentId = field.NewString(table, "parentId")
