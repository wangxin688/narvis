...
func GetIfTypeValue(ifType uint64) string {
	ifTypeValueMapping := map[uint64]string{
		1:   "other",
		2:   "regular1822",
		3:   "hdh1822",
		4:   "ddnX25",
	...
	return ifTypeValueMapping[ifType]
}

func GetIfAdminStatusValue(ifAdminStatus uint64) string {
	ifAdminStatusValueMapping := map[uint64]string{
		1: "up",
		2: "down",
		3: "testing",
	}
	return ifAdminStatusValueMapping[ifAdminStatus]
}

func GetIfOperStatusValue(ifOperStatus uint64) string {
	ifOperStatusValueMapping := map[uint64]string{
		1: "up",
		2: "down",
		3: "testing",
		4: "unknown",
