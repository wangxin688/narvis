...
func TestArubaOSDevice_Connect(t *testing.T) {

	// [1] test happy scenario with login -> userMode -> enableMode

	mockb := mockBase{}
	eosDevice := ArubaOSDevice{mockDriver{}, "", &mockb}
...
func TestArubaOSDevice_Disconnect(t *testing.T) {
	mockb := mockBase{}
	eosDevice := ArubaOSDevice{mockDriver{}, "", &mockb}
...
func TestArubaOSDevice_SendCommand(t *testing.T) {
	mockb := mockBase{}
	eosDevice := ArubaOSDevice{mockDriver{}, "", &mockb}
...
func TestArubaOSDevice_SendConfigSet(t *testing.T) {
